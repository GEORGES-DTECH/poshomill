...
class Transaction(models.Model):
    ...
    transaction_date = models.DateTimeField(default=timezone.now)
    employee=models.ForeignKey(settings.AUTH_USER_MODEL,on_delete=models.CASCADE)
    select_product1=models.ForeignKey(Product,related_name="ts1",on_delete=models.CASCADE,null=True,blank=True)
    select_product2=models.ForeignKey(Product,related_name="ts2",on_delete=models.CASCADE,null=True,blank=True)
    select_product3=models.ForeignKey(Product,related_name="ts3",on_delete=models.CASCADE,null=True,blank=True)
    select_product4=models.ForeignKey(Product,related_name="ts4",on_delete=models.CASCADE,null=True,blank=True)
    select_product5=models.ForeignKey(Product,related_name="ts5",on_delete=models.CASCADE,null=True,blank=True)
...
# ========================CUMULATIVE REPORTS===================================================================
    ...
    def total_purchases(self):
        result= Transaction.objects.aggregate(total=Sum(F('quantity_purchased') * F('price_per_each')))['total']
        return result
    ...
    def total_sales_amount(self):
      result= Transaction.objects.aggregate(total=Sum('total_selling_price'))
      return result[ 'total']
    ...
    def cost_of_sales(self):
        ...
        result= Transaction.objects.aggregate(total=Sum(F('quantity_used') * F('price_per_each')))['total']
        return result
...
# ====================creditors=====================================
    ...
    def total_mpesa_sales_amount(self):
      ...
      result= Transaction.objects.filter(mode_of_sale="Mpesa")\
    ...
    def total_cash_sales_amount(self):
      ...
      result= Transaction.objects.filter(mode_of_sale="Cash")\
          .aggregate(total=Sum('total_selling_price'))
      return result[ 'total']
    ...
    def total_bank_sales_amount(self):
      ...
      result= Transaction.objects.filter(mode_of_sale="Bank")\
          .aggregate(total=Sum('total_selling_price'))
      return result[ 'total']
    ...
    def total_mpesa_purchase_amount(self):
      ...
      result= Transaction.objects.filter(mode_of_purchase="Mpesa").\
    ...
    def total_cash_purchase_amount(self):
      ...
      result= Transaction.objects.filter(mode_of_purchase="Cash")\
          .aggregate(total=Sum(F('quantity_purchased') * F('price_per_each')))['total']
      return result
    ...
    def total_bank_purchase_amount(self):
      ...
      result= Transaction.objects.filter(mode_of_purchase="Bank")\
          .aggregate(total=Sum(F('quantity_purchased') * F('price_per_each')))['total']
      return result
