...
class Product5(models.Model):
    ...
    def get_absolute_url(self):
        return reverse("5product_create")
...
class Transaction5(models.Model):
    ...
    transaction_date = models.DateTimeField(default=timezone.now)
    employee=models.ForeignKey(settings.AUTH_USER_MODEL,on_delete=models.CASCADE,related_name='transaction5')
    select_product1=models.ForeignKey(Product5,related_name="ts11",on_delete=models.CASCADE,null=True,blank=True)
    select_product2=models.ForeignKey(Product5,related_name="ts12",on_delete=models.CASCADE,null=True,blank=True)
    select_product3=models.ForeignKey(Product5,related_name="ts13",on_delete=models.CASCADE,null=True,blank=True)
    select_product4=models.ForeignKey(Product5,related_name="ts14",on_delete=models.CASCADE,null=True,blank=True)
    select_product5=models.ForeignKey(Product5,related_name="ts15",on_delete=models.CASCADE,null=True,blank=True)
    ...
    def get_absolute_url(self):
        ...
        return reverse('5transaction_home')
...
# ========================CUMULATIVE REPORTS===================================================================
    ...
    def total_credit_sales(self):
        result= Transaction5.objects.filter(status="unpaid")\
    ...
    def total_paid_amount(self):
      result= Transaction5.objects.aggregate(total=Sum('amount_paid'))
      return result[ 'total']
    ...
    def total_purchases(self):
        result= Transaction5.objects.aggregate(total=Sum(F('quantity_purchased') * F('price_per_each')))['total']
        return result
    ...
    def total_expense(self):
        result= Transaction5.objects.aggregate(total=Sum('expense'))
        return result[ 'total']
    
    @cached_property
    def total_mpesa_expense(self):
        result= Transaction5.objects.filter(mode_of_payment="Mpesa").aggregate(total=Sum('expense'))
        return result[ 'total']

      
    @cached_property
    def total_cash_expense(self):
        result= Transaction5.objects.filter(mode_of_payment="Cash").aggregate(total=Sum('expense'))
        return result[ 'total']    
    
    
    @cached_property
    def total_sales_amount(self):
      result= Transaction5.objects.aggregate(total=Sum('total_selling_price'))
      return result[ 'total']
    ...
    def cost_of_sales(self):
        ...
        result= Transaction5.objects.aggregate(total=Sum(F('quantity_used') * F('price_per_each')))['total']
        return result
...
# ====================creditors=====================================
    ...
    def total_mpesa_sales_amount(self):
      ...
      result= Transaction5.objects.filter(mode_of_sale="Mpesa")\
    ...
    def total_cash_sales_amount(self):
      ...
      result= Transaction5.objects.filter(mode_of_sale="Cash")\
          .aggregate(total=Sum('total_selling_price'))
      return result[ 'total']
    ...
    def total_bank_sales_amount(self):
      ...
      result= Transaction5.objects.filter(mode_of_sale="Bank")\
          .aggregate(total=Sum('total_selling_price'))
      return result[ 'total']
    ...
    def total_mpesa_purchase_amount(self):
      ...
      result= Transaction5.objects.filter(mode_of_purchase="Mpesa").\
    ...
    def total_cash_purchase_amount(self):
      ...
      result= Transaction5.objects.filter(mode_of_purchase="Cash")\
          .aggregate(total=Sum(F('quantity_purchased') * F('price_per_each')))['total']
      return result
    ...
    def total_bank_purchase_amount(self):
      ...
      result= Transaction5.objects.filter(mode_of_purchase="Bank")\
          .aggregate(total=Sum(F('quantity_purchased') * F('price_per_each')))['total']
      return result
...
class Transactionreport5(models.Model):
    CHOICES=(
        ('Jan','Jan'),
        ('Feb', 'Feb'),
        ('Mar', 'Mar'),
    ...
    employee=models.ForeignKey(settings.AUTH_USER_MODEL,on_delete=models.CASCADE,related_name="Transactionreport5")
