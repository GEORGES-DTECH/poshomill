...
from django.contrib.auth.mixins import (
    ...
    LoginRequiredMixin,
    UserPassesTestMixin)
from .models import Transaction5,Transactionreport5,Product5
...
class SalesdetailView(LoginRequiredMixin,DetailView):
    model = Transaction5
    template_name = 'transactions5/salesdetail.html'
...
class PurchasedetailView(LoginRequiredMixin,DetailView):
    model = Transaction5
    template_name = 'transactions5/purchasedetail.html'
    context_object_name = 'transaction'
...
class DebtordetailView(LoginRequiredMixin,DetailView):
    model = Transaction5
    template_name = 'transactions5/debtordetail.html'
    context_object_name = 'transaction'
...
class CreditordetailView(LoginRequiredMixin,DetailView):
    model = Transaction5
    template_name = 'transactions5/creditordetail.html'
    context_object_name = 'transaction'
...
class IncomeHomeView(LoginRequiredMixin,ListView):
    model = Transaction5
    template_name = 'transactions5/income.html'
    context_object_name = 'transaction'
...
class ReportHome(LoginRequiredMixin,ListView):
    ...
    template_name = 'transactions5/reports.html'
...
class ProductHomeView(LoginRequiredMixin,ListView):
    model = Product5
    template_name = 'transactions5/productshome.html'
    paginate_by = 20
...
class TransactionHomeView(LoginRequiredMixin,ListView):
    model = Transaction5
    template_name = 'transactions5/transactionshome.html'
    context_object_name = 'transactions'
    transactions = Transaction5.objects.all()
...
class DailyReportsHomeView(LoginRequiredMixin,ListView):
    model = Transaction5
    template_name = 'transactions5/dailyreports.html'
    context_object_name = 'transactions'
...
class SaleView(LoginRequiredMixin,ListView):
    model = Transaction5
    template_name = 'transactions5/mysales.html'
    context_object_name = 'transactions'
    paginate_by = 5
    transactions = Transaction5.objects.all()
...
class PurchaseView(LoginRequiredMixin, ListView):
    model = Transaction5
    template_name = 'transactions5/mypurchases.html'
    context_object_name = 'transactions'
    paginate_by = 10
...
class StockView(LoginRequiredMixin, ListView):
    model = Transaction5
    template_name = 'transactions5/stock.html'
    context_object_name = 'transactions'
    paginate_by = 10
...
class ExpenseView(LoginRequiredMixin,ListView):
    model = Transaction5
    template_name = 'transactions5/myexpenses.html'
    context_object_name = 'transactions'
    paginate_by = 10
    transactions = Transaction5.objects.all()
...
class DebtorView(LoginRequiredMixin,ListView):
    model = Transaction5
    template_name = 'transactions5/mydebtors.html'
    context_object_name = 'transactions'
    paginate_by = 10
    transactions = Transaction5.objects.all()
...
class CreditorView(LoginRequiredMixin,ListView):
    model = Transaction5
    template_name = 'transactions5/mycreditors.html'
    context_object_name = 'transactions'
    paginate_by = 10
    transactions = Transaction5.objects.all()
...
class PerformanceView(LoginRequiredMixin,ListView):
    model = Transaction5
    template_name = 'transactions5/performance.html'
    context_object_name = 'transactions'
    paginate_by = 5
    transactions = Transaction5.objects.all()
...
class ReceiptView(LoginRequiredMixin,ListView):
    model = Transaction5
    template_name = 'transactions5/receipts.html'
...
class AccountHomeView(LoginRequiredMixin,ListView):
    model = Transaction5
    template_name = 'transactions5/accounts.html'
...
def new_expense(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return redirect('5transaction_home')
         
    else:
        form = ExpenseForm(request.user)
    return render(request, 'transactions5/expenseform.html', {'form': form})  
...
def new_purchase(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return redirect('5mypurchases')
    else:
        form = PurchaseForm(request.user)
    return render(request, 'transactions5/purchaseform.html', {'form': form})  
...
def new_creditor(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            transaction.employee = request.user
            transaction.save()
            return redirect('5mycreditors')
        
         
    else:
        form = CreditorForm(request.user)
    return render(request, 'transactions5/creditorform.html', {'form': form}) 
...
def new_debtor(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            transaction.employee = request.user
            transaction.save()
            return redirect('5mydebtors')
        
         
    else:
        form = DebtorForm(request.user)
    return render(request, 'transactions5/debtorform.html', {'form': form}) 
...
def new_transaction(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            transaction.employee = request.user
            transaction.save()
            return redirect('5sale_detail',transaction.id)
        
    else:
        form = TransactionForm(request.user)
    return render(request, 'transactions5/transactionform.html', {'form': form}) 
...
class TransactionPurchaseUpdateView(LoginRequiredMixin,  UpdateView):
    ...
    template_name = 'transactions5/purchaseform.html'
    fields = (
        'products_purchased',
        'quantity_purchased',
        'price_per_each',
...
class TransactionExpenseUpdateView(LoginRequiredMixin,  UpdateView):
    model = Transaction5
    template_name = 'transactions5/expenseform.html'
    fields = (
        'expense',
        'expense_description',
        'mode_of_payment'
...
class TransactionDebtorView(LoginRequiredMixin,  UpdateView):
    ...
    template_name = 'transactions5/debtorform.html'
    fields = (
        'select_product1',
        'select_product2',
        'select_product3',
...
class TransactionUpdateView(LoginRequiredMixin,  UpdateView):
    ...
    template_name = 'transactions5/transactionform.html'
    fields = (
        'select_product1',
        'select_product2',
        'select_product3',
...
class ProductDelete(LoginRequiredMixin, UserPassesTestMixin, DeleteView,):
    ...
    success_url = reverse_lazy('5products')
...
class TransactionDeleteView(LoginRequiredMixin, UserPassesTestMixin, DeleteView,):
    ...
    context_object_name = 'transaction'
    success_url = reverse_lazy('5transaction_home')
...
class ReportDeleteView(LoginRequiredMixin, UserPassesTestMixin, DeleteView,):
    ...
    success_url = reverse_lazy('5reports_home')
...
class SearchResultView(ListView):
    ...
    def get_queryset(self):
        ...
        object_list = Transactionreport5.objects.filter(
...
class TransactionSearchResultView(ListView):
    ...
    def get_queryset(self):
        ...
        query = self.request.GET.get('q')
        object_list = Transaction5.objects.filter(
